...
export const TOOL_LABELS: Record<string, string> = {
  ...
  "ic-threat-intel-lookup": "Threat Intel Lookup",
  "ic-deploy-metric-join": "Deploy ↔ Metrics JOIN",
  "ic-notify-slack": "Notify Slack",
  "ic-create-jira-ticket": "Create Jira Ticket",
  "ic-rollback-deployment": "Rollback Deployment",
  "ic-block-ip": "Block Suspicious IP",
  "ic-index-incident-report": "Index Incident Report",
...
export const REMEDIATION_TOOL_IDS = new Set([
  ...
  "ic-rollback-deployment",
  "ic-block-ip",
  "ic-notify-slack",
  "ic-create-jira-ticket",
  "ic-index-incident-report",
]);
